...
class DebeziumSchemas:
    ...
    def get_customer_payload():
        ...
        return StructType([
            ...
            StructField("date_of_birth", IntegerType(), True),
            StructField("nationality", StringType(), True),
            StructField("risk_score", IntegerType(), True),
            StructField("kyc_status", StringType(), True),
            StructField("onboarding_date", LongType(), True),
    ...
    def get_account_payload():
        ...
        return StructType([
            ...
            StructField("status", StringType(), True),
            StructField("opened_date", LongType(), True),
            StructField("last_activity_date", LongType(), True),
            StructField("created_at", LongType(), True),
            StructField("updated_at", LongType(), True),
            # Debezium ExtractNewRecordState metadata fields
            StructField("__op", StringType(), True),
